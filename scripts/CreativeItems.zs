...
mods.extendedcrafting.TableCrafting.addShaped(<appliedenergistics2:creative_energy_cell>, [
	...
	[<ore:ingotUltimate>, <enderio:item_endergy_conduit:11>, <enderio:item_endergy_conduit:11>, <enderio:item_endergy_conduit:11>, <appliedenergistics2:controller>, <enderio:item_endergy_conduit:11>, <enderio:item_endergy_conduit:11>, <enderio:item_endergy_conduit:11>, <ore:ingotUltimate>],
	[<avaritia:block_resource:1>, <appliedenergistics2:dense_energy_cell>, <appliedenergistics2:dense_energy_cell>, <draconicevolution:chaotic_core>, <enderio:item_endergy_conduit:11>, <draconicevolution:chaotic_core>, <appliedenergistics2:dense_energy_cell>, <appliedenergistics2:dense_energy_cell>, <avaritia:block_resource:1>],
